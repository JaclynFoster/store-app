...
const contactRequest = async (req, res) => {
  ...
  try {
    const response = await queryInvoke(`INSERT INTO contact (contact_name, contact_email, contact_message)
    VALUES ($1, $2, $3)`, [contact_name, contact_email, contact_message])
